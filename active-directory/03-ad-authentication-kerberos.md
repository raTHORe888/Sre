...
## Interview Q&A: Kerberos in AD

### Q1: What are the 3 Kerberos exchanges in AD?
...
### Q2: Why is time synchronization critical for Kerberos?
...
### Q3: What is an SPN and why does duplicate SPN break auth?
...
### Q4: Explain `KRB_AP_ERR_MODIFIED` in one line.
...
### Q5: Kerberos vs NTLM — when does NTLM still appear?
...
### Q6: What is TGT vs Service Ticket?
...
### Q7: What is Kerberoasting and how do you reduce risk?
...
### Q9: Golden Ticket vs Silver Ticket?

- **Golden Ticket**: forged TGT using KRBTGT hash (domain-wide impact). Recovery requires KRBTGT double reset.
- **Silver Ticket**: forged service ticket using service account hash (service-scoped impact).

### Q10: Why is KRBTGT reset done twice?

To invalidate both current and previous KRBTGT keys retained for compatibility during ticket validation windows. Resets must be spaced 10+ hours apart.

### Q11: What is delegation in Kerberos and safest model?
...
### Q12: How do you triage "user can log in but cannot access SQL"?
...
### Q13: What event IDs matter most for Kerberos?
...
### Q14: Why does DNS directly impact Kerberos?
...
### Q15: Interview whiteboard: "Intermittent Kerberos failures only in one site"
